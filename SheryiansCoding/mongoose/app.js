...
app.get("/create", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var userCreated;
...
app.get("/update", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var updatedUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user.findOneAndUpdate({ userName: "Imman" }, { name: "Rabab007" }, { new: true })];
            case 1:
                updatedUser = _a.sent();
